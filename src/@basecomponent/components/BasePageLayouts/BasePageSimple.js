...
import { BaseScrollbars } from '@basecomponent';
import { BaseThemes } from '@basecomponent/index';
...
const styles = theme => ({
    ...
    header: {
        ...
        display: 'flex',
        // backgroundImage: 'url("../../movie_showcase/assets/images/backgrounds/header-bg.png")',
...
class BasePageSimple extends React.Component {
    state = {
        leftSidebar: false,
        rightSidebar: false
    };
    ...
    render() {
        ...
        const Sidebar = (header, content, variant) => (
            <BaseScrollbars enable={innerScroll}>
                {header && (
                    <MuiThemeProvider theme={BaseThemes['mainThemeDark']}>
        ...
        return (
            ...
            >
                ...
                <div className={classes.contentWrapper}>
                    ...
                    >
                        <BaseScrollbars className={classes.contentCard} enable={innerScroll && !sidebarInner}>
...
BasePageSimple.propTypes = propTypes;
BasePageSimple.defaultProps = defaultProps;

export default withStyles(styles, { withTheme: true })(BasePageSimple);
