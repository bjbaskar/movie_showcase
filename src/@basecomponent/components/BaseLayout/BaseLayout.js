...
class BaseLayout extends Component {
    ...
    render() {
        ...
        const Layout = BaseLayouts[settings.layout.style].component;
        return (
...
export default withStyles(styles, { withTheme: true })(withRouter(connect(mapStateToProps, mapDispatchToProps)(BaseLayout)));
