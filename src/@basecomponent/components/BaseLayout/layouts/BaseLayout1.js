...
import { BaseScrollbars, BaseThemes } from '@basecomponent';
...
class BaseLayout1 extends Component {
    ...
    render() {
        ...
        // console.warn('BaseLayout:: rendered');
        ...
        const navbarContentTemplate = (
            <BaseScrollbars className={classes.navbarContent}>
                {navbarContent}
            </BaseScrollbars>
        );

        const navBarTemplate = (
            <MuiThemeProvider theme={BaseThemes[settings.theme.navbar]}>
                <div id="base-navbar"
                ...
                >
                    <Hidden mdDown>
                        <div
                            ...
                            style={{ backgroundColor: BaseThemes[settings.theme.navbar].palette.background.default }}
                        >
        ...
        const toolbarTemplate = (
            <MuiThemeProvider theme={BaseThemes[settings.theme.toolbar]}>
                <AppBar id="base-toolbar" className={classNames(classes.toolbarWrapper)} color="default">
        ...
        const footerTemplate = (
            <MuiThemeProvider theme={BaseThemes[settings.theme.footer]}>
                <AppBar id="base-footer" className={classNames(classes.footerWrapper)} color="default">
                    <Toolbar className="p-0">
        ...
        switch (layoutConfig.scroll) {
            case 'body':
                {
                    return (
                        <div id="base-layout" className={classNames(classes.root, layoutConfig.mode, 'scroll-' + layoutConfig.scroll)}>
                            ...
                            <div className="flex flex-1 flex-col overflow-hidden relative">
                                ...
                                <BaseScrollbars className="overflow-auto">
                            ...
                            <div className="flex flex-1 flex-col overflow-hidden relative">
                                ...
                                <div className={classes.wrapper}>
                                    ...
                                    <div className={classes.contentWrapper}>
                                        ...
                                        <BaseScrollbars className={classes.content}>
                                            {toolbar && layoutConfig.toolbar.display && layoutConfig.toolbar.position === 'below' && layoutConfig.toolbar.style !== 'fixed' && (
                                                toolbarTemplate
                                            )}
...
function mapStateToProps({ base }) {
    return {
        defaultSettings: base.settings.defaults,
        settings: base.settings.current,
        navbar: base.navbar
    }
}

BaseLayout1.defaultProps = defaultProps;

export default withStyles(styles, { withTheme: true })(withRouter(connect(mapStateToProps, mapDispatchToProps)(BaseLayout1)));
