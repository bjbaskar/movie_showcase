...
class BaseScrollbars extends Component {
    constructor(props)
    {
        super(props);
...
BaseScrollbars.propTypes = propTypes;
BaseScrollbars.defaultProps = defaultProps;

export default withStyles(styles, {withTheme: true})(withRouter(connect(mapStateToProps, mapDispatchToProps)(BaseScrollbars)));
